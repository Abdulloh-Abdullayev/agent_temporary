...
mixin _$TokenModel {
  ...
  @JsonKey(name: 'refresh_token_expiry_time')
...
class _$_TokenModel implements _TokenModel {
  _$_TokenModel(
      ...
      @JsonKey(name: 'refresh_token_expiry_time') this.expireTime});
  ...
  @override
  String toString() {
    return 'TokenModel(token: $token, refreshToken: $refreshToken, expireTime: $expireTime)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, token, refreshToken, expireTime);
...
abstract class _TokenModel implements TokenModel {
  factory _TokenModel(
      ...
      @JsonKey(name: 'refresh_token')
          final String? refreshToken,
      @JsonKey(name: 'refresh_token_expiry_time')
          final DateTime? expireTime}) = _$_TokenModel;
