...
class DebtorsBloc
    extends Bloc<DebtorsEvent, DebtorsState> {
  List<Region> cacheList = [
    Region(id: 1, name: "Select All", isSelected: false,),
    Region(id: 2, name: "Xasanobot",  isSelected: false,),
    Region(id: 3, name: "Dumbrabod",  isSelected: false,),
    Region(id: 4, name: "Asakaobop",  isSelected: false,),
    Region(id: 5, name: "Toshkent",   isSelected: false,),
  ];
