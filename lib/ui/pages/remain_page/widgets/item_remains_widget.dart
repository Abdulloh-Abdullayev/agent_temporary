                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        SizedBox(
                                                            ...
                                                            child: Center(
                                                              child: AppWidgets.textLocale(
                                                                  localeKey: state.counterValueBlokCola.toString(),
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .w400,
                                                                  color:
                                                        ...
                                                        InkWell(
                                                          onTap: () {
                                                            BlocProvider.of<RemainCubit>(context).incrementColaBloc();
                                                          },
                                                          child: Container(
                                                            height: 20,
                                                            width: 22,
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        InkWell(
                                                          onTap: () {
                                                          //  BlocProvider.of<RemainCubit>(context).decrementColaSHT();
                                                          },
                                                          child: Container(
                                                            height: 20,
                                                            width: 22,
                                                        ...
                                                        SizedBox(
                                                            ...
                                                            child: Center(
                                                              child: AppWidgets.textLocale(
                                                                  localeKey:
                                                                      state.counterValueBlokCola.toString(),
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .w400,
                                                                  color:
                                                        ...
                                                        InkWell(
                                                          onTap: () {
                                                            // BlocProvider.of<RemainCubit>(context).incrementColaSHT();
                                                          },
                                                          child: Container(
                                                            height: 20,
                                                            width: 22,
