...
import 'ui/pages/debtors_orders_page/debtors_orders_page.dart';
import 'ui/pages/debtors_orders_page/debtors_orders_report_page.dart';
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Modular.setInitialRoute(DebtorsOrdersReportPage.routeName);
